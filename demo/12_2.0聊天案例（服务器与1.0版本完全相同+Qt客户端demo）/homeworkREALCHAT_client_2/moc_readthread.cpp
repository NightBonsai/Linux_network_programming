...
QT_MOC_LITERAL(1, 11, 12), // "send2ChatWin"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "CHATMSG*"
QT_MOC_LITERAL(4, 34, 7), // "chatMsg"
QT_MOC_LITERAL(5, 42, 11), // "send2LogWin"
QT_MOC_LITERAL(6, 54, 4) // "flag"

    },
    "ReadThread\0send2ChatWin\0\0CHATMSG*\0"
    "chatMsg\0send2LogWin\0flag"
};
...
void ReadThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send2ChatWin((*reinterpret_cast< CHATMSG*(*)>(_a[1]))); break;
        case 1: _t->send2LogWin((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ReadThread::*_t)(CHATMSG * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReadThread::send2ChatWin)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReadThread::send2LogWin)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ReadThread::send2ChatWin(CHATMSG * _t1)
{
...
// SIGNAL 1
void ReadThread::send2LogWin(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
