...
QT_MOC_LITERAL(1, 10, 15), // "toChatWinSIGNAL"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 9), // "toChatWin"
QT_MOC_LITERAL(4, 37, 8) // "logJudge"

    },
    "LogWidget\0toChatWinSIGNAL\0\0toChatWin\0"
    "logJudge"
};
...
void LogWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->toChatWinSIGNAL(); break;
        case 1: _t->toChatWin(); break;
        case 2: _t->logJudge(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogWidget::toChatWinSIGNAL)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LogWidget::toChatWinSIGNAL()
{
